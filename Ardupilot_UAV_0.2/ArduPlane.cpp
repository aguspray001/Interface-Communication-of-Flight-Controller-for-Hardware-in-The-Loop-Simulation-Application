...
const AP_Scheduler::Task Plane::scheduler_tasks[] = {
                           // Units:   Hz      us
    SCHED_TASK(ahrs_update,           400,    400), //400 400
    ...
    SCHED_TASK(userhook_FastLoop,   100,     75), //100 75
#endif
#ifdef USERHOOK_50HZLOOP
    SCHED_TASK(userhook_50Hz,         50,     100),
#endif
...
void Plane::update_flight_mode(void)
{
    ...
    case STABILIZE:
        nav_roll_cd        = 0; //roll_data*-0.01 --kirim ke aileron
        nav_pitch_cd       = 0;
